...
export default function Trends() {
  ...
  const industries = [
    { id: 'food', labelKey: 'industry.food' },
    { id: 'beauty', labelKey: 'industry.beauty' },
    { id: 'apparel', labelKey: 'industry.apparel' },
    { id: 'ec', labelKey: 'industry.ec' },
    { id: 'education', labelKey: 'industry.education' },
    { id: 'it_saas', labelKey: 'industry.it_saas' },
    { id: 'btob', labelKey: 'industry.btob' },
    { id: 'realestate', labelKey: 'industry.realestate' },
    { id: 'travel', labelKey: 'industry.travel' },
    { id: 'fitness', labelKey: 'industry.fitness' },
    { id: 'medical', labelKey: 'industry.medical' },
    { id: 'entertainment', labelKey: 'industry.entertainment' },
    { id: 'influencer', labelKey: 'industry.influencer' },
    { id: 'local', labelKey: 'industry.local' },
    { id: 'startup', labelKey: 'industry.startup' },
    { id: 'recruitment', labelKey: 'industry.recruitment' },
    { id: 'automotive', labelKey: 'industry.automotive' },
    { id: 'finance', labelKey: 'industry.finance' },
    { id: 'pet', labelKey: 'industry.pet' },
    { id: 'construction', labelKey: 'industry.construction' },
    { id: 'other', labelKey: 'industry.other' },
  ];
  ...
  const analyzeTrends = async () => {
    ...
    if (!industryValue) {
      setError(t('trends.selectOrEnterIndustry'));
      return;
    }
    ...
    try {
      ...
      if (!response.ok) {
        setError(t('trends.errorMessage'));
        setLoading(false);
        return;
      }
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-8">
          <div className="mb-8">
            ...
            <p className="text-gray-500 mt-2">{t('trends.subtitle')}</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-3">{t('trends.selectIndustry')}</label>
                <select
                ...
                >
                  <option value="">{t('trends.selectIndustryPlaceholder')}</option>
              ...
              {selectedIndustry === 'other' && (
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-3">{t('trends.enterIndustry')}</label>
                  <input
                    type="text"
                    value={customIndustry}
                    onChange={(e) => setCustomIndustry(e.target.value)}
                    placeholder={t('trends.enterIndustryPlaceholder')}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-gray-900"
                  />
                </div>
              )}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-3">{t('trends.platform')}</label>
              ...
              >
                {loading ? (
                  <>
                    ...
                    <span>{t('trends.analyzing')}</span>
                  </>
                ) : (
                  <>
                    <i className="ri-search-line text-xl"></i>
                    <span>{t('trends.analyze')}</span>
                  </>
                )}
              </button>
            </div>
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 rounded-xl p-6 mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-red-900">{t('trends.error')}</h3>
                  ...
                  {trendData.trendingTopics.map((topic, index) => (
                    <div key={index} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-all">
                      ...
                      <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-3 mb-3">
                        <p className="text-xs font-medium text-emerald-700 mb-1">{t('trends.whyTrending')}</p>
                        <p className="text-sm text-emerald-900">{topic.whyTrending}</p>
                      </div>
                      <div>
                        <p className="text-xs font-medium text-gray-700 mb-2">{t('trends.postExamples')}</p>
                  ...
                  {trendData.contentFormats.map((format, index) => (
                    <div key={index} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-all">
                      ...
                      <div className="bg-purple-50 border border-purple-200 rounded-lg p-3">
                        <p className="text-xs font-medium text-purple-700 mb-1">{t('trends.whyEffective')}</p>
